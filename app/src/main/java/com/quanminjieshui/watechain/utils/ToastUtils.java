package com.quanminjieshui.watechain.utils;
...
import com.quanminjieshui.watechain.WateChainApplication;
...
public class ToastUtils {
    ...
    public static void showCustomToast(String textStr) {
        View layout = LayoutInflater.from(WateChainApplication.getInstance()).inflate(R.layout.layout_toast, null);
        TextView text = (TextView) layout.findViewById(R.id.toast_text_tv);
        text.setText(textStr);
        Toast toast = new Toast(WateChainApplication.getInstance());
    ...
    public static void showCustomToastMsg(String message, int yOffset) {
        View layout = LayoutInflater.from(WateChainApplication.getInstance()).inflate(R.layout.layout_discover_toast, null);
    ...
    public static void showSuccessToast(String msg) {
        Toast toast = new Toast(WateChainApplication.getInstance());
        View view = View.inflate(WateChainApplication.getInstance(), R.layout.layout_view_toast, null);
